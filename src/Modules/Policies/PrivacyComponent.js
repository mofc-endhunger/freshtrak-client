						...
						<div className="privacy">
							...
							<ul>
								...
								<li>
									...
									responding to requests from courts or other
									government bodies.
								</li>
							</ul>
							<h4 className="mb-2 medium-title font-weight-bold">
							...
							<ul>
								<li>
									...
									We partner with third parties to assist with
									the operation of our Website, including
									fulfilling requests, advertising, analyzing
									your interests and activity on our Website,
									and helping us communicate with you. These
									third parties may provide services related
									to the purposes described above, and we may
									share with them any types of information
									described in Information We Collect. We may
									also receive information collected by these
									third parties and combine it with
									information we have collected. Your
									information may also be collected and
									processed by third parties who will process
									your information independently in accordance
									with their own privacy policies.
								</li>
								<li>
									<strong>Other Third Parties:</strong> We
									will disclose your personal information,
									without notice, if required to do so by law
									or in the good faith belief that such action
									is necessary to: (a) conform to the edicts
									of the law or comply with legal process
									served on FreshTrak; (b) protect and defend
									the rights or property of FreshTrak; and,
									(c) act under exigent circumstances to
									protect the personal safety of users of
									FreshTrak or the public.
								</li>
							</ul>
							<h4 className="mb-2 medium-title font-weight-bold">
							...
							<p className="mobile-text-left caption-text">
								You can control the information we collect and
								use in the following ways:
							</p>
							<ul>
								<li>
									<strong>Location Information:</strong> You
									can disable location-based services on your
									mobile device or web browser by adjusting
									the settings on your device or browser. This
									will prevent our Website from accessing your
									location information. Note that some
									services may not be available if you disable
									location-based services.
								</li>
								<li>
									<strong>Online Advertising:</strong> For
									information about opting out of third party
									advertising, visit: NAI Opt-Out and DAA
									Opt-Out (you will leave this Website for a
									separately managed online site where you can
									specify your preference under those
									programs). You can also click on the icon
									that may appear on some of our advertising
									served through these technologies. We may
									use more than one third party company for
									placing this advertising, which would
									require you to opt out of each company.
								</li>
							</ul>
							<h4 className="mb-2 medium-title font-weight-bold">
								Children's Privacy
							...
							<p className="mobile-text-left caption-text">
								...
								the age of 13. No one under 13 should share any
								personal information with us. We do not
								knowingly collect any personal information from
								children under 13. If we learn that we have
								collected the personal information of a child
								under the age of 13, we will make reasonable
							...
							<p className="mobile-text-left caption-text">
								We recommend that you use the latest web browser
							...
							<p className="mobile-text-left caption-text">
								Our Website may enable you to navigate to
								third-party websites through links on our
								Websites. We do this for your convenience. We do
								not endorse, may not have any affiliation with,
								do not control, and are not responsible for
								those third-party websites and/or their Internet
								and web practices. We encourage you to review
								the privacy statements of websites you choose to
								link to from our Website so that you can
								understand how those websites collect, use and
							...
							<p className="mobile-text-left caption-text">
								We take steps to help protect the
								confidentiality and security of your
								information. Although we use measures to protect
								your information, in general, information
								transmitted through the Internet may not be
								completely secure. Accordingly, we cannot
								guarantee the security of information provided
								over the Internet or stored in our databases.
								Your transmissions are, therefore, at your own
								risk.
							</p>
							<h4 className="mb-2 medium-title font-weight-bold">
								Contact Information
							...
							<p className="mobile-text-left caption-text">
								We will make updates to our privacy practices
								from time to time. If we make any material
								changes to our privacy practices, we will update
								this privacy notice and change the effective
