...
const renderAdditionalPickUpForm = () => {
	return render(
		<AdditionalPickUpFormComponent onSelectedChild={mockOnSelectedChild} />
	);
};
...
describe("AdditionalPickUpFormComponent", () => {
	...
	describe("Initial Rendering", () => {
		it("renders the main heading", () => {
			...
			expect(
				screen.getByText("Additional Pickup Information (Optional)")
			).toBeInTheDocument();
		});
		...
		it("renders pickup name input field", () => {
			...
			expect(pickupNameInput).toHaveAttribute(
				"placeholder",
		...
		it("renders vehicle license plate input field", () => {
			...
			expect(licensePlateInput).toHaveAttribute(
				"id",
	...
	describe("State Management", () => {
		it("initializes with empty state values", () => {
			...
			const pickupNameInput = screen.getByLabelText(
				"Name"
			) as HTMLInputElement;
			const licensePlateInput = screen.getByLabelText(
				"Vehicle License Plate Number"
	...
	describe("Visual Elements and Styling", () => {
		...
		it("applies proper font weights", () => {
			...
			const labels = screen.getAllByText(
				/Who's Picking up\?|Name|Vehicle License Plate Number/
			);
		...
		it("applies proper background colors and borders", () => {
			...
			const addVehicleButton = screen
				.getByText("Add a Vehicle")
				.closest("div");
			const infoBox = screen
				.getByText(/Where possible, when you arrive/)
				.closest("div");

			expect(addVehicleButton).toHaveClass(
				"bg-gray-50",
				"border-gray-200"
			);
	...
	describe("Component Integration", () => {
		it("forwards ref correctly", () => {
			...
			render(
				<AdditionalPickUpFormComponent
					ref={ref}
					onSelectedChild={mockOnSelectedChild}
				/>
			);
		...
		it("has proper display name", () => {
			expect(AdditionalPickUpFormComponent.displayName).toBe(
				"AdditionalPickUpFormComponent"
			);
		});
