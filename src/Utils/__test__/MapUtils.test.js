...
describe('MapUtils', () => {
  ...
  describe('formatAddress', () => {
    it('should format address correctly', () => {
      const result = formatAddress('123 Main St', 'Columbus', 'OH', '43215');
  ...
  describe('calculateDistance', () => {
    it('should calculate distance between two points', () => {
      ...
      const result = calculateDistance(39.9612, -82.9988, 41.4993, -81.6944);
  ...
  describe('geocodeAddress', () => {
    ...
    it('should return null when both APIs fail', async () => {
      ...
      const result = await geocodeAddress('Invalid Address', 'Invalid City', 'XX', '00000');
