...
const RegistrationTextInfoComponent: React.FC<RegistrationTextInfoComponentProps> = ({
  event,
  onRegisterNow,
}) => {
        ...
        <Card className="w-full md:w-1/2 border-none shadow-none p-0">
          <CardContent className="py-6 px-0">
            <div className="day-view">
              <EventCardComponent key={event.id} event={event as any} registrationView={true} />
            </div>
          </CardContent>
        </Card>
      )}
