 ...
 * ```
 */
const DashBoardFoodBankComponent: React.FC<DashBoardFoodBankComponentProps> = () => (
  <div className="container mx-auto px-4 pt-24 pb-24 max-w-7xl">
    <div className="text-center uppercase">{localization.for_foodbanks}</div>
    <h2 className="my-2 font-bold text-center text-2xl">{localization.home_dashboard}</h2>
    <p className="text-center caption-text">{localization.home_dashboard_org}</p>
