          ...
          <div className="row mt-3">
            <div className="col-12">
              <div className="mb-2 medium-title font-weight-bold">
                FreshTrak is a new resource for finding food, clothing, and other assistance in your
                local area.
              </div>
              <p className="mobile-text-left caption-text">
                Built by the Mid-Ohio Foodbank, we’re working to make it easier for you to support
                your family whenever and wherever we can. For nearly 40 years we’ve been helping our
                friends and neighbors stay fed through local action. FreshTrak is our way of using
                the promise of the internet to speed up the line, provide options that better fit
                your family’s needs, and respond faster in times of crisis.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-12">
              ...
              <p className="mobile-text-left  text-center caption-text">
                We get there by listening to our neighbors, understanding their needs, and being
                available when you need us the most. If you’d like to know more about the Mid-Ohio
                Foodbank and our mission, please visit us at{' '}
                <span>
                  <a
