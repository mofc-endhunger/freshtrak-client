    ...
    return (
      <div data-testid="household-info-display">
        ...
        <div data-testid="household-address">
          {householdData.address_line_1}, {householdData.city}, {householdData.state}{' '}
          {householdData.zip_code}
        </div>
        <div data-testid="household-members">
          {householdData.counts.adults} adults, {householdData.counts.children} children,{' '}
...
describe('HouseholdConfirmationModal', () => {
  ...
  describe('Error Handling', () => {
    test('displays error message when error is provided', () => {
      ...
      render(<HouseholdConfirmationModal {...defaultProps} error={errorMessage} />);
    ...
    test('does not display error when error is undefined', () => {
      ...
      const visibleErrors = errorElements.filter((el) => !el.classList.contains('sr-only'));
