...
import { calculateAge, formatDateOfBirth, formatPhoneNumber } from './utils/householdUtils';
...
export const MemberCard: React.FC<MemberCardProps> = ({
  ...
  const getFullName = (): string => {
    const parts = [member.first_name, member.middle_name, member.last_name, member.suffix].filter(
      Boolean,
    );
    return parts.join(' ');
  };
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>Born: {formatDateOfBirth(member.date_of_birth)}</span>
              </div>
          ...
          {showActions && (
            <div className="flex flex-col space-y-2">
              ...
              <div className="flex space-x-2">
                ...
                <Button onClick={() => onViewDetails?.(member)} variant="outline" size="sm">
