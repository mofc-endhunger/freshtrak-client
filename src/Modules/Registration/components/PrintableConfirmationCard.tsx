...
const PrintableConfirmationCard: React.FC<PrintableConfirmationCardProps> = ({
	...
	return (
		<div className="print-confirmation-card">
			<h1 className="text-4xl font-bold text-[#392947] mb-6">
				Registration Confirmation
			</h1>
			<h2 className="text-3xl font-bold text-[#392947] mb-4">
				{event.agencyName}
			</h2>
			{agencyAddress && (
			...
			<div className="text-2xl font-semibold text-[#392947] mb-2">
				{eventDateFormatted}
			</div>
			...
			<div className="mt-8">
				<div className="text-2xl font-bold text-[#392947] mb-2">
					Confirmation Number:
				</div>
				<div className="text-3xl font-bold text-[#009F56]">
					{identificationCode.toUpperCase()}
				</div>
			</div>
		</div>
	);
