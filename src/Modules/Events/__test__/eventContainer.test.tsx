...
import { mockFoodBank, renderWithRouter, mockEvent } from "../../../Testing";
...
jest.mock("../EventListContainer", () => {
	return function MockEventListContainer() {
		return (
			<div data-testid="mock-event-list-container">
				Mock Event List Container
			</div>
		);
	};
});
