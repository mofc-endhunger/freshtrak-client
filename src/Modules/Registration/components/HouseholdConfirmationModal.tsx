		...
		<Dialog open={isOpen} onOpenChange={handleClose}>
			...
			>
				...
				<div id="review-button-description" className="sr-only">
					Navigate to the registration form to review and update your
					household information before registering.
				</div>
				<div id="confirm-button-description" className="sr-only">
					Register immediately using your existing household
					information.
				</div>
				<div id="error-description" className="sr-only">
					An error occurred during registration. You can review and
