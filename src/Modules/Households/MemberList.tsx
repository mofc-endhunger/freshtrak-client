  ...
  useEffect(() => {
    const loadMembers = async () => {
      try {
        ...
        const response = await householdsApiService.getHousehold(householdId);
    ...
    return (
      <div className={`flex items-center justify-center min-h-64 ${className}`}>
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading household members...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <Select
                ...
                onValueChange={(value) => handleFilterChange('freshtrakUser', value)}
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="yes">FreshTrak Users</SelectItem>
                  <SelectItem value="no">Non-FreshTrak Users</SelectItem>
                </SelectContent>
              </Select>
              ...
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    ...
                    variant={sortOptions.field === 'age' ? 'default' : 'outline'}
                    size="sm"
                  >
                    Age
