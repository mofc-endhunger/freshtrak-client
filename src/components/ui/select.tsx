...
const SelectTriggerComponent = React.forwardRef(SelectTrigger);
...
const SelectContentComponent = React.forwardRef(SelectContent);
...
const SelectLabelComponent = React.forwardRef(SelectLabel);
...
const SelectItemComponent = React.forwardRef(SelectItem);
