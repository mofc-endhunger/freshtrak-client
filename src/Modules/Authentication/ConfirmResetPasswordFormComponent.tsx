 ...
 */
const ConfirmResetPasswordFormComponent: React.FC<ConfirmResetPasswordFormComponentProps> = ({
  email,
  onSuccess,
  onError,
  onBackToReset,
  ...
  const onSubmit = async (data: ConfirmResetPasswordFormFields): Promise<void> => {
    try {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-sm text-gray-600">We sent a confirmation code to this email address</p>
      </div>
