...
const CaseManagerLoginPage: React.FC = () => {
  ...
  const onSubmit = async (data: FormData): Promise<void> => {
    ...
    try {
      ...
      setErrorMessage(error?.message || localization.cm_login_error_generic);
    } finally {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-start justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-md p-6">
        <h1 className="text-2xl font-bold mb-2 text-center">{localization.cm_login_title}</h1>
        <p className="text-sm text-gray-500 text-center mb-6">{localization.cm_login_subtitle}</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="cm-email">{localization.cm_login_email_label}</Label>
            <Input
              id="cm-email"
              type="email"
          ...
          <div className="space-y-2">
            <Label htmlFor="cm-password">{localization.cm_login_password_label}</Label>
            <Input
              id="cm-password"
              type="password"
