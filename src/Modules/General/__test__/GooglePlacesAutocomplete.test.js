    ...
    maps: {
      places: {
        AutocompleteSuggestion: {
          fetchAutocompleteSuggestions: jest.fn().mockResolvedValue(mockSuggestionsResponse),
        },
...
describe('GooglePlacesAutocomplete', () => {
  ...
  test('applies custom className', () => {
    render(<GooglePlacesAutocomplete {...defaultProps} className="custom-class" />);
    const input = screen.getByRole('textbox');
  ...
  test('calls onSelect with place details when suggestion is clicked', async () => {
    ...
    render(<GooglePlacesAutocomplete {...defaultProps} onSelect={onSelect} />);
    const input = screen.getByRole('textbox');
  ...
  test('handles API errors gracefully', async () => {
    // Mock API to reject
    window.google.maps.places.AutocompleteSuggestion.fetchAutocompleteSuggestions = jest
      .fn()
