...
export const HouseholdSetupOffer: React.FC<HouseholdSetupOfferProps> = ({
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Have a complete profile for seamless event registration',
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Welcome to FreshTrak!</h1>
          <p className="text-lg text-gray-600">
            Your account has been successfully created. Let's set up your household to get the most
            out of FreshTrak.
          </p>
        </div>
        ...
        <Card className="mb-8">
          <CardHeader>
            <CardTitle className="text-xl text-center">Why Set Up Your Household?</CardTitle>
            <CardDescription className="text-center">
              Setting up your household helps us provide you with personalized services
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-500">
            You can always set up your household later in your account profile. This helps us
            provide you with better personalized services.
          </p>
        </div>
      </div>
    </div>
