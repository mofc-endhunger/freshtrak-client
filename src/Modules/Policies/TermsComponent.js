	...
	return (
		<Fragment>
			<div className="container pt-100 pb-100 register-confirmation">
				...
				<p className="mobile-text-left caption-text">
					Your use of the Website confirms your acceptance of the
					Terms and your agreement to be bound by them. If you do not
					accept these Terms, do not use the Website. In the event of
					a violation of these Terms, we reserve the right to seek all
					remedies available by law and in equity. We may terminate
					your access or use of this Website at any time, for any
				...
				<p className="mobile-text-left caption-text">
					...
					and international laws and treaties. The User is granted no
					right, title or interest in or to the Website Content other
					than the limited license expressly set forth in these Terms.
					The User may not modify, publish, transmit, participate in
					the transfer or sale of, reproduce, create derivative works
					from, distribute, perform, display, incorporate into a
					website or in any way exploit the Website Content, or any
					portion thereof, without the express written permission of
					FreshTrak.
				</p>
				<h4 className="mb-2 medium-title font-weight-bold">
					Trademarks
				...
				<p className="mobile-text-left caption-text">
					...
					Content via the Website. The User shall retain ownership of
					all User Content and hereby grants to FreshTrak a
					non-exclusive, royalty-free, transferable, worldwide right
					and license to use, reproduce, modify, adapt, publish,
					translate, transmit, distribute and display the User Content
					via the Website, and for our business purposes. The User
					also grants to the other users of the Website a
					non-exclusive license to access the User Content via the
					Website, and to use, reproduce, distribute, and display such
					User Content as permitted through the functionality thereof
					and subject to these Terms. The User grants FreshTrak the
					right to identify the User as the author of any such User
					Content by name, email address, or screen name, and the User
					acknowledges that FreshTrak has the right, but is not
					obligated, to use any such User Content and that FreshTrak
					may cease utilizing such User Content at any time for any
					reason. The User agrees not to submit, upload, or otherwise
					...
					(iii) with respect to which the User does not have the
					rights necessary to transmit and publish such content or
					materials, or to grant FreshTrak the license to use such
					content or materials as described herein. The User
					acknowledges that FreshTrak has no obligation to monitor or
					screen User Content submitted to the Website, but that
					FreshTrak shall have the right (but not the obligation) to
					reject, remove or delete any User Content at its sole
					discretion.
				</p>
				<h4 className="mb-2 medium-title font-weight-bold">
					License to Use
				...
				<p className="mobile-text-left caption-text">
					Subject to these Terms and any other agreement between you
					and us, we grant you a limited, personal, nonexclusive,
					nontransferable, revocable license to use the Website for
					your personal non-commercial purposes and in a manner
					enabled by us. This limited license allows you to download
					copies of materials on our Website for personal use only.
					This is a grant of license, not a transfer of title, and
					under this license you many not (i) modify or copy the
					materials, (ii) use the materials for any commercial purpose
					or for any public display, (iii) attempt to decompile or
					reverse engineer any software contained on our Website, (iv)
					remove any copyright or other proprietary notations from the
					materials, or (v) transfer the materials to another person.
					This license shall automatically be revoked if you violate
					any of these restrictions, and may be revoked by FreshTrak
					at any time.
				</p>
				<h4 className="mb-2 medium-title font-weight-bold">
					Third Party Content
				...
				<p className="mobile-text-left caption-text">
					...
					stalks, threatens, defames, or otherwise infringes or
					violates the rights of FreshTrak or any third party
					(including, without limitation, the rights of publicity or
					other proprietary rights), (iii) uses technology or other
					means not authorized by FreshTrak to access Website content,
					(iv) attempts to introduce viruses or any other computer
					...
					terms of service) at all times while using the Website.
					FreshTrak reserves the right to, in its sole discretion,
				...
				<p className="mobile-text-left caption-text">
					The User represents and warrants that (i) the User is at
					least 13 years of age and is fully competent and able to
					...
					provides the Website for use in the United States of
				...
				<p className="mobile-text-left caption-text">
					...
					provided by applicable law, FreshTrak will not be liable to
					you or to any other person under any circumstances or under
					any legal or equitable theory, whether in tort, contract,
					strict liability, or otherwise, for any indirect, special,
					incidental, or consequential losses or damages of any nature
					arising out of or in connection with the use of or inability
					to use the Website. To the fullest extent provided by
					applicable law, this limitation of liability applies to any
					damages or injury arising from any failure of performance,
					error, omission, interruption, deletion, defects, delay in
					operation or transmission, lost profits, loss of goodwill,
					loss of data, work stoppage, accuracy of results, computer
					failure or malfunction, computer viruses, file corruption,
					communication failure, network or system outage, theft,
					destruction, unauthorized access to, alteration of, loss of
					use of any record or data, and any other tangible or
					intangible loss. Subject to the foregoing, to the fullest
					extent provided by applicable law, FreshTrak will not be
					liable for any damages in connection with your use of this
					Website.
				</p>
				<h4 className="mb-2 medium-title font-weight-bold">
					Disclaimer
				...
				<p className="mobile-text-left caption-text">
					While we exercise reasonable efforts to ensure the accuracy
					of information on our Website and accessible through our
					services, you acknowledge and agree that your use of the
					...
					that your use is at your sole risk. Some jurisdictions do
					not allow the disclaimer of implied warranties. In such
					jurisdictions, the foregoing disclaimer may not apply to
					you.
				</p>
				<h4 className="mb-2 medium-title font-weight-bold">
					Indemnity
				...
				<p className="mobile-text-left caption-text">
					...
					indemnification by the User, in which event the User will
					cooperate with FreshTrak in asserting any available
					defenses.
				</p>
				<h4 className="mb-2 medium-title font-weight-bold">
					Social Media Policy
				...
				<p className="mobile-text-left caption-text">
					Please note that any content you post to social medial
					platforms is subject to the data handling practices of each
					social media platform, as described in their respective
					terms of use and privacy policy, which you should read
				...
				<p className="mobile-text-left caption-text">
					...
					requirements set forth above, for any injunctive relief
				...
				<p className="mobile-text-left caption-text">
					At any time and without notice to the User, FreshTrak may
					change or modify the Website, or any features or functions
					thereof, or may suspend or discontinue the Website, or stop
					supporting the Website, or any aspect thereof. Any such
					termination, change, suspension or discontinuance shall be
					without liability to the User.
				</p>
				<h4 className="mb-2 medium-title font-weight-bold">
					Changes to Terms
				</h4>
				<p className="mobile-text-left caption-text">
					...
					supplements, or replacements – in which case such separate
					terms will apply.
				</p>
				<h4 className="mb-2 medium-title font-weight-bold">
					Contact Us
