  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      ...
      <div className="flex-1">
        <p className="text-sm text-gray-600">{operation || localization.loading_loading}</p>
        {progress !== undefined && (
  ...
  const getMessage = () => {
    switch (status) {
      ...
      case 'success':
        return (
          successMessage ||
          localization.status_operation_completed_successfully ||
  ...
  return (
    ...
    >
      ...
      {status === 'error' && onRetry && (
        <Button onClick={onRetry} variant="ghost" size="sm" className="flex items-center space-x-1">
