...
const AdditionalPickUpFormComponent = forwardRef<HTMLDivElement, AdditionalPickUpFormProps>(
  ({ onSelectedChild }, ref) => {
    ...
    const buildAddressForm = (event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => {
      ...
      <div ref={ref} className="space-y-6 pt-12">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="pickup_type" className="text-sm font-medium text-gray-700">
              Who's Picking up?
            </Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="pickup_name" className="text-sm font-medium text-gray-700">
              Name
            </Label>
            <Input
              type="text"
          ...
          <div className="space-y-2">
            <Label htmlFor="vehicle_number_plate" className="text-sm font-medium text-gray-700">
        ...
        <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
          <p className="text-sm text-blue-800">
            Where possible, when you arrive we'll look for your vehicle and bring your goods to you.
