...
const ButtonComponent = ({
  ...
  const variantClasses = {
    custom:
      'bg-secondary text-white px-9 py-3 min-h-12 rounded-lg uppercase text-sm tracking-wide font-bold min-w-55 w-full sm:w-auto',
    default:
    ...
    search:
      'bg-secondary text-white px-9 py-3 min-h-12 rounded-lg uppercase text-sm tracking-wide font-bold min-w-55 w-full sm:w-auto mt-2.5 sm:mt-0',
  };
