...
describe('EventSlotsModalComponent Accessibility', () => {
  ...
  describe('ARIA Attributes and Roles', () => {
    ...
    it('should have proper radiogroup role for time slots', async () => {
      ...
      await waitFor(() => {
        ...
        expect(radiogroup).toHaveAttribute('aria-labelledby', 'timeslot-modal-title');
      });
    });
    ...
    it('should have proper legend for radiogroup', async () => {
      ...
      await waitFor(() => {
        const legend = screen.getByText('Available time slots for registration');
    ...
    it('should have proper radio button attributes', async () => {
      ...
      await waitFor(() => {
        ...
        radioButtons.forEach((radio, index) => {
          ...
          expect(radio).toHaveAttribute('aria-describedby', `time_slot_${slotId}-description`);
        });
      });
    });
  ...
  describe('Loading State Accessibility', () => {
    it('should have proper loading state ARIA attributes', () => {
      ...
      expect(loadingContainer).toHaveAttribute('aria-label', 'Loading time slots');
    });
  });
  ...
  describe('Button Accessibility', () => {
    it('should have proper button descriptions', async () => {
      ...
      await waitFor(() => {
        ...
        expect(backButton).toHaveAttribute('aria-describedby', 'back-button-description');
        expect(continueButton).toHaveAttribute('aria-describedby', 'continue-button-description');
      });
    });
    ...
    it('should have hidden descriptions for screen readers', async () => {
      ...
      await waitFor(() => {
        const backDescription = screen.getByText(/Return to the previous page/);
        const continueDescription = screen.getByText(/Proceed with registration/);
    ...
    it('should enable continue button when slot selected', async () => {
      renderWithRouter(<EventSlotsModalComponent {...defaultProps} selectedSlotId="slot1" />);
  ...
  describe('Keyboard Navigation', () => {
    ...
    it('should handle arrow key navigation for radio buttons', async () => {
      ...
      renderWithRouter(<EventSlotsModalComponent {...defaultProps} onSlotChange={onSlotChange} />);
  ...
  describe('Screen Reader Support', () => {
    it('should provide meaningful content for screen readers', async () => {
      ...
      await waitFor(() => {
        ...
        expect(descriptions.length).toBeGreaterThan(0);
        expect(screen.getByText('Available time slots for registration')).toBeInTheDocument();
      });
    });
    ...
    it('should announce slot availability', async () => {
      ...
      await waitFor(() => {
        const descriptions = screen.getAllByText(/\d+ slots? available/);
