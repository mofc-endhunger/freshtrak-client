    ...
    const getPlacePredictions = async (input: string) => {
      ...
      try {
        ...
        if (isApiAvailable) {
          ...
          const mappedSuggestions: GooglePlace[] = apiSuggestions.map((suggestion) => ({
      ...
      if (isApiAvailable && window.google?.maps?.places?.Place) {
        try {
          ...
          const mappedPlace: GooglePlaceDetails = {
            ...
            address_components: (placeDetails.addressComponents || []).map((component) => ({
              long_name: component.longText,
              short_name: component.shortText,
              types: component.types,
            })),
            formatted_address: placeDetails.formattedAddress || suggestion.description,
