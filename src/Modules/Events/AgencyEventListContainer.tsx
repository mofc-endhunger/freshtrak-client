...
const AgencyEventListContainer: React.FC<AgencyEventListContainerProps> = (props) => {
  ...
  return (
    <div className="container mx-auto px-4 mt-24">
      ...
      {error && <h1 className="text-2xl font-bold text-red-600">Something went wrong</h1>}
      {!loading && targetAgency && (
        <div className="pb-4">
          <h1 className="text-3xl font-bold text-gray-900">Events for {targetAgency.nickname}</h1>
        </div>
      )}
      {!loading && agencyEvents && (
        <div className="bg-gray-100">
          <div className="container mx-auto px-4 pt-24 pb-24">
            <EventListComponent
              events={agencyEvents as unknown as Record<string, Event[]>}
              showHeader={false}
              zipCode=""
            />
          </div>
