...
const AuthenticationModal: React.FC<ExtendedAuthenticationModalProps> = ({
  ...
  const [justConfirmedEmail, setJustConfirmedEmail] = useState<boolean>(false);
  ...
  const { resendConfirmationCode, isAuthenticated, user, setNeedsHouseholdSetup } = useAuth();
  ...
  const handleAuthSuccess = (): void => {
    ...
    const isCognitoAuthenticated = isAuthenticated || StorageService.isLoggedInUser();
  ...
  return (
    <Dialog key={show ? 'open' : 'closed'} open={show} onOpenChange={handleOpenChange}>
      <DialogContent
      ...
      >
        ...
        <div className="p-6">
            ...
            <>
              ...
              {currentTab === 'loading' && (
                <div className="w-full flex flex-col items-center justify-center py-8">
                  ...
                  <p className="mt-4 text-gray-600 text-center">Processing your request...</p>
                </div>
              )}
            </>
          )}
          ...
          {/* Guest Login Option */}
          {showGuestLogin && currentTab !== 'confirm' && currentTab !== 'loading' && (
            <div className="mt-6 pt-4">
              ...
              <div className="text-center mt-4">
                <Button variant="outline" onClick={onGuestLogin} className="w-full">
