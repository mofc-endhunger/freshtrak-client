...
import { ArrowLeft, Users, ArrowUpDown, ChevronLeft, ChevronRight, Search } from 'lucide-react';
...
const getColumns = (): ColumnDef<CmRegistration>[] => [
  {
    ...
    cell: ({ row }) => <span className="text-gray-500 font-mono text-xs">{row.original.id}</span>,
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="flex items-center gap-2">
          <span className="font-medium text-gray-900">{getFullName(reg)}</span>
          <span
...
const CaseManagerRegistrationsPage: React.FC = () => {
  ...
  const globalFilterFn = useMemo(
    () =>
      (row: { original: CmRegistration }, _columnId: string, filterValue: string): boolean => {
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">
                {localization.cm_my_registrations || 'My Registrations'}
              </h1>
        ...
        {isLoading ? (
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 text-center">
            ...
            <Button variant="outline" onClick={fetchRegistrations} className="mt-4">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-12 text-center">
            ...
            <Button onClick={() => navigate(RENDER_URL.ROOT_URL)} className="bg-primary text-white">
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            ...
            <div className="p-4 border-b">
              <div className="relative max-w-sm">
                ...
                <Input
                  placeholder={
                    localization.cm_search_placeholder || 'Search by name, event, email or phone...'
                  }
                  value={globalFilter}
            ...
            <div className="flex items-center justify-between px-4 py-3 border-t">
              ...
              <div className="flex items-center gap-2">
                <span className="text-sm text-gray-700">
                  {localization.cm_table_page || 'Page'} {table.getState().pagination.pageIndex + 1}{' '}
