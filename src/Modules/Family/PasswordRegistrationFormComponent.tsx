...
const PasswordRegistrationFormComponent = forwardRef<HTMLDivElement, PasswordRegistrationFormProps>(
  ({ register, errors, getValues }, ref) => (
    <div ref={ref} className="space-y-6">
      <div className="text-center md:text-left">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Create FreshTrak Account</h2>
        <p className="text-sm text-gray-600 max-w-md mx-auto md:mx-0">
          Input a password to create a FreshTrak account and easily register with one click in the
          future
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          {errors?.password_confirm && (
            <span className="text-sm text-red-600">{errors.password_confirm.message}</span>
          )}
        </div>
      </div>
    </div>
...
PasswordRegistrationFormComponent.displayName = 'PasswordRegistrationFormComponent';
