  ...
  return function MockStateDropdownComponent(props: any) {
    return (
      <div data-testid="state-dropdown">
        ...
        {props.error && (
          <span className="text-sm text-red-600" data-testid="state-error">
            {props.error}
          </span>
        )}
      </div>
...
describe('AddressComponent', () => {
  ...
  describe('Form Fields', () => {
    ...
    test('should have proper input attributes', () => {
      ...
      const addressLine2Input = screen.getByTestId('address-line-2-input');
  ...
  describe('Form Validation', () => {
    test('should show error messages for required fields', () => {
      ...
      expect(screen.getByTestId('address-line-1-error')).toBeInTheDocument();
    ...
    test('should not show error messages when no errors', () => {
      ...
      expect(screen.queryByTestId('address-line-1-error')).not.toBeInTheDocument();
      expect(screen.queryByTestId('city-error')).not.toBeInTheDocument();
      expect(screen.queryByTestId('zip-code-error')).not.toBeInTheDocument();
    });
  });
  ...
  describe('Google Places Integration', () => {
    test('should render Google Places Autocomplete', () => {
      ...
      const googlePlacesInput = screen.getByTestId('address-line-1-input');
  ...
  describe('Responsive Design', () => {
    ...
    test('should have responsive grid layout', () => {
      renderComponent();
      const gridContainer = screen.getByTestId('address-component').querySelector('.grid');
